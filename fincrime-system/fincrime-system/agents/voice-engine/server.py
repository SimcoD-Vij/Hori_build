...
DEFAULT_AUDIT_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../data/audit_log.jsonl"))
FINCRIME_AUDIT_LOG = os.environ.get("FINCRIME_AUDIT_LOG", DEFAULT_AUDIT_PATH)
